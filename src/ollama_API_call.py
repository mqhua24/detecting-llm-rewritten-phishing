...
# OUTPUT_CSV = f"../qwen3_dataset_output/qwen3_fused_phishing_output{type}_new.csv"
# ERROR_CSV = f"../qwen3_dataset_output/qwen3_fused_phishing_errors{type}_new.csv"

INPUT_CSV = "../fusion_dataset_output/phishing_fused_1000.csv"
OUTPUT_CSV = f"../local_llama_dataset_output/llama3/local_llama_fused_phishing_output{type}_new2.csv"
ERROR_CSV = f"../local_llama_dataset_output/llama3/local_llama_fused_phishing_errors{type}_new2.csv"
...
if __name__ == "__main__":
    TEST_N = None  # 调试时改成 1 或 5；正式跑可以设为 None
